# Agricultural Production (LP) {#sec-lp-chirps}
...
This chapter uses @jorda2005estimation Local Projection framework to measure how sensitive agricultural output is to exogenous changes in the weather. It complements [Chapter -@sec-lp-piscop] and used CHIRPS precipitation data instead of Piscop.
...
```{r}
#| code-fold: true
#| fig-cap: Agricultural production response to a weather shock, using PISCOp vs. CHIRPS data
